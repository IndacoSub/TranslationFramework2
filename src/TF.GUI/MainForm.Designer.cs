namespace TF.GUI
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// 
			// mniBulkTextsExportXlsx
			// 
			resources.ApplyResources(this.mniBulkTextsExportXlsx, "mniBulkTextsExportXlsx");
			this.mniBulkTextsExportXlsx.Name = "mniBulkTextsExportXlsx";
			this.mniBulkTextsExportXlsx.Click += new System.EventHandler(this.mniBulkTextsExportXlsx_Click);
			// 
			// mniBulkTextsImportXlsx
			// 
